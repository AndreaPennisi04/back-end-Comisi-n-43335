...
switch (PERSISTENCE) {
  case "MONGO":
    ...
    console.log("🚀 ~ file: factory.js:24 ~ ProductServiceDao:", ProductServiceDao);
  ...
  default:
    ...
    console.log(`PERSISTENCE ${PERSISTENCE}`);
    const { default: ProductServiceDao2 } = await import("../repository/product.repository.js");
    console.log("🚀 ~ file: factory.js:36 ~ ProductServiceDao2:", ProductServiceDao2);

...
export const getAllBooks = async (req, res) => {
  try {
    ...
    console.log("🚀 ~ file: book.controller.js:13 ~ getAllBooks ~ error:", error);
  }
};
...
export const getBookById = async (req, res) => {
  try {
    ...
    console.log("🚀 ~ file: book.controller.js:30 ~ getBookById ~ error:", error);
  }
};
...
export const createBook = async (req, res) => {
  try {
    ...
    console.log("🚀 ~ file: book.controller.js:34 ~ createBook ~ error:", error);
  }
};
...
export const updateBookById = async (req, res) => {
  try {
    ...
    console.log("🚀 ~ file: book.controller.js:63 ~ updateBookById ~ error:", error);
  }
};
...
export const deleteBookById = async (req, res) => {
  try {
    ...
    console.log("🚀 ~ file: book.controller.js:79 ~ deleteBookById ~ error:", error);
  }
};

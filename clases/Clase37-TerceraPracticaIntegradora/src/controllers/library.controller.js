...
export const getAllLibraries = async (req, res) => {
  try {
    ...
    console.log("🚀 ~ file: library.controller.js:14 ~ getAllLibraries ~ error:", error);
  }
};
...
export const getLibraryById = async (req, res) => {
  try {
    ...
    console.log("🚀 ~ file: library.controller.js:30 ~ getLibraryById ~ error:", error);
  }
};
...
export const createLibrary = async (req, res) => {
  try {
    ...
    console.log("🚀 ~ file: library.controller.js:35 ~ createLibrary ~ error:", error);
  }
};
...
export const updateLibraryById = async (req, res) => {
  try {
    ...
    console.log("🚀 ~ file: library.controller.js:61 ~ updateLibraryById ~ error:", error);
  }
};
...
export const deletelibraryById = async (req, res) => {
  try {
    ...
    console.log("🚀 ~ file: library.controller.js:81 ~ deletelibraryById ~ error:", error);
  }
};

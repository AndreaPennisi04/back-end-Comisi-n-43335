...
export default class LibraryDao {
  getAllLibraries = async () => {
    try {
      ...
      console.log("🚀 ~ file: library.dao.js:9 ~ LibraryDao ~ getLibraries= ~ error:", error);
      return null;
    }
  };
  ...
  getLibraryById = async (id) => {
    try {
      ...
      console.log("🚀 ~ file: library.dao.js:22 ~ LibraryDao ~ getUsersById= ~ error:", error);
      return null;
    }
  };
  ...
  createLibrary = async (library) => {
    try {
      ...
      console.log("🚀 ~ file: library.dao.js:18 ~ LibraryDao ~ createLibrary= ~ error:", error);
    }
  };
  ...
  updateLibraryById = async (id, library) => {
    try {
      ...
      console.log("🚀 ~ file: library.dao.js:48 ~ LibraryDao ~ updateLibraryById= ~ error:", error);
      return null;
    }
  };
  ...
  deletelibraryById = async (id) => {
    try {
      ...
      console.log("🚀 ~ file: library.dao.js:61 ~ LibraryDao ~ deletelibraryById ~ error:", error);
      return null;
    }
  };
}

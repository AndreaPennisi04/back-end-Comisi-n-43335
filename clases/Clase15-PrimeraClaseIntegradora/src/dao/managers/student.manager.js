...
class StudentManager {
  getAllStudents = async () => {
    try {
      ...
      console.log("🚀 ~ file: students.routes.js:42 ~ StudentsRoutes ~ this.router.get ~ error:", error);
    }
  };
  ...
  getStudentById = async (id) => {
    try {
      ...
      console.log("🚀 ~ file: student.manager.js:22 ~ StudentManager ~ getStudentById= ~ error:", error);
    }
  };
  ...
  createStudent = async (bodyStudent) => {
    try {
      ...
      console.log("🚀 ~ file: student.manager.js:42 ~ StudentManager ~ createStudent= ~ error:", error);
    }
  };
}

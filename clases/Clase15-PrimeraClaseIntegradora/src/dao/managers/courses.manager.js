...
class CoursesManager {
  getAllCourses = async () => {
    try {
      ...
      console.log("🚀 ~ file: courses.manager.js:10 ~ CoursesManager ~ getAllCourses= ~ err:", err);
    }
  };
  ...
  getCourseById = async (id) => {
    try {
      ...
      console.log("🚀 ~ file: courses.manager.js:21 ~ CoursesManager ~ getCourseById= ~ err:", err);
    }
  };
  ...
  createCourses = async (courseBody) => {
    try {
      ...
      console.log("🚀 ~ file: courses.manager.js:45 ~ CoursesManager ~ createCourses=async ~ error:", error);
    }
  };
}

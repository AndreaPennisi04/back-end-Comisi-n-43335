  ...
  initStudentsRoutes() {
    this.router.get(`${this.path}/insertion`, async (req, res) => {
      try {
        ...
        console.log("🚀 ~ file: students.routes.js:25 ~ StudentsRoutes ~ this.router.get ~ error:", error);
      }
    });
    ...
    this.router.get(`${this.path}`, async (req, res) => {
      try {
        ...
        console.log("🚀 ~ file: students.routes.js:44 ~ StudentsRoutes ~ this.router.get ~ error:", error);
      }
    });
    ...
    this.router.get(`${this.path}/:studentId`, async (req, res) => {
      try {
        ...
        const studentDetail = await this.studentManager.getStudentById(studentId);
        ...
        console.log("🚀 ~ file: students.routes.js:60 ~ StudentsRoutes ~ this.router.get ~ error:", error);
      }
    });
    ...
    this.router.post(`${this.path}`, async (req, res) => {
      try {
        ...
        console.log("🚀 ~ file: students.routes.js:79 ~ StudentsRoutes ~ this.router.post ~ error:", error);
      }
    });
  }
}

...
export default class OrdersDao {
  ...
  getOrdersById = async (id) => {
    try {
      ...
      console.log("🚀 ~ file: orders.dao.js:16 ~  ~ getOrdersById= ~ error:", error);
      return null;
    }
  };
  ...
  createOrder = async (order) => {
    try {
      ...
      console.log("🚀 ~ file: orders.dao.js:26 ~  ~ createOrders= ~ error:", error);
      return null;
    }
  };
  ...
  updateOrdersById = async (id, order) => {
    try {
      ...
      console.log("🚀 ~ file: orders.dao.js:36 ~  ~ updateOrdersById= ~ error:", error);
      return null;
    }
  };
  ...
  deleteOrdersById = async (id) => {
    try {
      ...
      console.log("🚀 ~ file: orders.dao.js:47 ~  ~ DeleteOrdersById ~ error:", error);
      return null;
    }
  };
}

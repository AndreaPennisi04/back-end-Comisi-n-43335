...
export default class BussinessDao {
  ...
  updateBussinessById = async (id, bussiness) => {
    try {
      ...
      console.log("🚀 ~ file: bussiness.dao.js:49 ~ BussinessDao ~ updateBussinessById= ~ error:", error);
      return null;
    }
  };
  ...
  deleteBussinessById = async (id) => {
    try {
      ...
      console.log("🚀 ~ file: bussiness.dao.js:62 ~ BussinessDao ~ deleteBussinessById ~ error:", error);
      return null;
    }
  };
}

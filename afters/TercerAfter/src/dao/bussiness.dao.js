...
export default class BussinessDao {
  getBussiness = async () => {
    try {
      ...
      console.log("🚀 ~ file: bussiness.dao.js:9 ~ BussinessDao ~ getBussiness= ~ error:", error);
      return null;
    }
  };
  ...
  getBussinessById = async (bid) => {
    try {
      ...
      console.log("🚀 ~ file: bussiness.dao.js:22 ~ BussinessDao ~ getBussinessById= ~ error:", error);
      return null;
    }
  };
  ...
  createBussiness = async (bussiness) => {
    try {
      ...
      console.log("🚀 ~ file: bussiness.dao.js:35 ~ BussinessDao ~ createBussiness= ~ error:", error);
      return null;
    }
  };
  ...
  updateBussinessById = async (bid, bussiness) => {
    try {
      ...
      console.log("🚀 ~ file: bussiness.dao.js:48 ~ BussinessDao ~ updateBussinessById= ~ error:", error);
      return null;
    }
  };
  ...
  deleteBussinessById = async (bid) => {
    try {
      ...
      console.log("🚀 ~ file: bussiness.dao.js:61 ~ BussinessDao ~ deleteBussinessById ~ error:", error);
      return null;
    }
  };
}
